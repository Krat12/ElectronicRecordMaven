...
CREATE TABLE `diplom` (
  ...
  `Thesis` varchar(60) DEFAULT NULL,
  PRIMARY KEY (`Diplom_id`),
  CONSTRAINT `Diplom_Reatin_FK` FOREIGN KEY (`Diplom_id`) REFERENCES `reating` (`reating_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2019-02-12 18:11:32
